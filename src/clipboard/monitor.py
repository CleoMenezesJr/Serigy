...
class ClipboardMonitor:
    def __init__(
        ...
        polling_callback: Callable[[Optional[str]], None] = None,
    ):
        ...
        self._settings_handler_id = Settings.get().connect(
            "changed::image-polling", self._on_image_polling_changed
        )
    ...
    def _on_image_poll(self) -> bool:
        ...
        if self.polling_callback:
            self._is_processing = True
            self.polling_callback(self.last_text_hash)
